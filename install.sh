#!/usr/bin/env sh
# Install docker-port-forward as a Docker CLI plugin in the
...
#   VERSION=0.0.1 curl -fsSL https://raw.githubusercontent.com/dokku/docker-port-forward/main/install.sh | sh
#
...
REPO="dokku/docker-port-forward"
