...
type mockDockerClient struct {
	...
	containerLogs    func(ctx context.Context, containerID string, options dockerClient.ContainerLogsOptions) (io.ReadCloser, error)
	...
	containerStop    func(ctx context.Context, id string, options dockerClient.ContainerStopOptions) error
...
func (m *mockDockerClient) ContainerList(ctx context.Context, options dockerClient.ContainerListOptions) ([]container.Summary, error) {
...
func (m *mockDockerClient) ContainerLogs(ctx context.Context, containerID string, options dockerClient.ContainerLogsOptions) (io.ReadCloser, error) {
...
func (m *mockDockerClient) ContainerRemove(ctx context.Context, id string, options dockerClient.ContainerRemoveOptions) error {
...
func (m *mockDockerClient) ContainerStart(ctx context.Context, id string, options dockerClient.ContainerStartOptions) error {
...
func (m *mockDockerClient) ContainerStop(ctx context.Context, id string, options dockerClient.ContainerStopOptions) error {
...
func (m *mockDockerClient) ImagePull(ctx context.Context, ref string, options dockerClient.ImagePullOptions) (io.ReadCloser, error) {
	if m.imagePull != nil {
